            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="persona.fechaDeNacimiento.label" default="Fecha De Nacimiento" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${personaInstance?.fechaDeNacimiento}" /></td>
